      ...
      <Container>
        <FooterPages>
          ...
          <FooterListNoMarker>
            ...
            <FooterItem>
              * Ми тимчасово не доставляємо замовлення на окуповані території в
              Донецькій, Луганській, Херсонскій, Запорізькій, Харківській
              областях і в Крим.
            </FooterItem>
          </FooterListNoMarker>
          ...
          <FooterListNoBottom>
            ...
            <FooterItem>
              Доставка Новою Поштою становить до доби в межах Києва і до 2 днів
              по Україні.
            </FooterItem>
          </FooterListNoBottom>
          ...
          <FooterListNoBottom>
            ...
            <p>
              {" "}
              Ти можеш відстежити статус замовлення на сайті кур'єрської служби:
            </p>
            <FooterItem>
              {" "}
          ...
          <FooterListNoMarker>
            ...
            <FooterItem>
              Вартість доставки розраховується на етапі оформлення замовлення на
              сайті.
            </FooterItem>
            <FooterItem>
            ...
            <FooterItem>
              ...
              отриманні), то необхідно буде сплатити комісію за переказ грошових
              коштів — 20 грн + 2% від суми замовлення;
            </FooterItem>
            <FooterItem>
