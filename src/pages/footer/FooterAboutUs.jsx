          ...
          <FooterPages>
            <MediaQuery maxWidth={1023.98}>
              <FooterSectionColumn>
                ...
                />
                <FooterItemText>
                  Ласкаво просимо до PulseRun – мого улюбленого куточку для тих,
                ...
                <DetailsTogglerSecond>
                  <FooterItemText>
                    &quot;У PulseRun ми пропонуємо вам великий вибір брендового
                    ...
                    у спорті. Дякую, що обрали PulseRun – ваш партнер у кожному
            ...
            <MediaQuery minWidth={1024}>
              <FooterSection>
                ...
                <FooterSectionColumn>
                  ...
                  <DetailsTogglerSecond>
                    <FooterItemText>
                      &quot;У PulseRun ми пропонуємо вам великий вибір
                      ...
                      PulseRun призначена для того, щоб допомагати вам досягати
                      нових висот у спорті. Дякую, що обрали PulseRun – ваш
