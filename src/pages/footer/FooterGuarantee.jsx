          ...
          <FooterPages>
            <FooterListNoMarker>
              ...
              <FooterItem>
                ...
                зобов'язання відповідно до чинного законодавства. Гарантійний
                термін вказується на кожному товарі окремо. У разі виявлення
                дефектів, що виникли в результаті виробничого процесу, ми
                зобов'язуємося замінити товар або повернути кошти.{" "}
              </FooterItem>
            </FooterListNoMarker>
            ...
            <FooterListNoMarker>
              ...
              <FooterItem>
                ...
                зв'яжемося з вами та надамо вказівки щодо процедури повернення.
              </FooterItem>
            </FooterListNoMarker>
            ...
            <FooterList>
              ...
              <FooterItem>
                Грошовий повернення здійснюється за допомогою того ж методу
