        ...
        <swiper-container
          ...
          style={{
            ...
            "--swiper-button-next-background-image":
              "url(/icons/White Circular Buttons.png)",
          ...
          {brands["id"].map(index => {
            return (
              <swiper-slide class="swiper" key={index}>
                <Links to={`/catalog?brand=${brands["title"][index - 1]}`}>
                  <img
                    src={brands["img"][index - 1]}
                    alt={brands["title"][index - 1]}
                    width={149}
                    height={101}
                    loading="eager"
                  />
                  <Text>{brands["title"][index - 1]}</Text>
                </Links>
              </swiper-slide>
            );
          })}
