...
export default function BasicModal({ openModal, closeModal, productData,sizeValue }) {
  ...
  return (
    <div>
      ...
      >
        <Box sx={style}>
          <button onClick={closeModal} style={{ position: 'absolute', top: 10, right: 20, padding: '8px',background:'none',border:'none', fontSize:36 }}>
            x
          </button>
<h1>Додати в кошик</h1>
<div>
